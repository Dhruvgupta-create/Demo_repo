                    ...
                    <div className='md:col-span-2'>
                      <div className="flex items-center gap-5">
                          <figure className='max-w-[200px] max-h-[200px]'>
                            ...
                            <div>
                              <span className='bg-cyan-50  text-irisBlueColor py-1 px-6 lg:py-2 lg:px-2 txt-[12px] leading-4 lg:text-[16px]
                                                lg:leading-7 font-semibold rounded'> 
                                              surgeon
                              </span>
                              <h3 className='text-headingColor text-[22px] leading-9 mt-3 font-blue'>
                                            Dhruv Gupta
                              </h3>
                              <div className="flex items-center gap-[6px]">
                                ...
                                <p className='text_para text-[14px] leading-5 md:text-[15px]'>Lorem ipsum dolor sit amet.</p>
                              
                            </div>
                         </div>

                         <div className='mt-[50px] border-b border-solid border-purple'>
