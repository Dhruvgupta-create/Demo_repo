...
const Home = () => {
  return (
    <>
          ...
          <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
            ...
            <div>
              <div className='lg:w-[570px]'>
                <h1 className='text-[36px] leading-[46px] text-headingColor font-[800] md:text-[60px] md:leading-[70px]'>WE Help patients to connect to Doctors</h1>
                <p className='text-para'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Tenetur animi saepe eligendi, officia aperiam eaque, esse in alias odit vel soluta enim deserunt unde earum id, sequi laboriosam ipsa consectetur.</p>
      ...
      <section>
        <div className="container">
          <div className='lg:w-[470px] mx-auto'>
            ...
            <p className='text_para text-center'>World class care for everyone</p>
          </div>
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] lg-gap-[30px] mt-[30px] lg:mt-[55px]'>
            <div className='py-[30px] px-5'>
              <div className='flex items-center justify-center'><img src={icon01} alt='' /></div>
              <div className='mt-[30px]'>
                <h2 className='text-[26px] leading-9 text-headingColor font-[700] text-center'>Find a Doctor</h2>
                <p className='text-[16px] leading-7 text-textColor font-[400] mt-4 text-center'>World class care</p>
            ...
            <div className='py-[30px] px-5'>
              ...
              <div className='mt-[30px]'>
                <h2 className='text-[26px] leading-9 text-headingColor font-[700] text-center'>Get Location</h2>
                <p className='text-[16px] leading-7 text-textColor font-[400] mt-4 text-center'>World class care</p>
                <Link to='/doctors' className='w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] mt-[30px] mx-auto flex items-center justify-center group hover:bg-primaryColor hover:border-none'>
                  <BsArrowRight className='group-hover:text-white w-6 h-5' />
                </Link>
              ...
              <div className='xl:w-[670px]'>
                ...
                <ul className="pl-4">
                  <li className="text_para">
                     1.schedeule the appointemt directly
                  </li>
                  <li className="text_para">
                    2. search for your physician here 
                  </li>
                  <li className="text_para">
                    3. view your physician who accepts new patients
                  </li>
                  <Link to='/'>
              ...
              <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0">
                ...
                <div className='w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 z-20 p-2 pb-3 
                                lg:pt-4  lg:px-4 lg:pb-[26px] rounded-[10px]'>
                                  ...
                                  <div className='w-[65px] lg:w-[96px] bg-black py-1 px-2 lg:py-[6px] lg:px-[10px]  text-[8px]
      ...
      {/* our greate doctors section ends */}
      {/* faq section */}
      <section>
        <div className="container">
